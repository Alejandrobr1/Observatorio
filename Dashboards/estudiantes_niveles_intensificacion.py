...
st.set_page_config(layout="wide", page_title="Dashboard MCER por Genero - Intensificación")
st.title("📊 Estudiantes por Nivel MCER y Genero - Intensificación")
...
with engine.connect() as connection:
    # Total personas con intensificación
    query_total = text("""
    ...
    st.sidebar.metric("Total Personas - Intensificación", f"{total_personas:,}")

    # Personas con nivel MCER en intensificación
    ...
    st.sidebar.metric("Con Nivel MCER - Intensificación", f"{total_con_nivel:,}")

st.sidebar.divider()

# Consulta principal FILTRADO POR INTENSIFICACIÓN
try:
    with engine.connect() as connection:
        ...
        # Consulta principal CON INTENSIFICACIÓN
        query = text(f"""
            SELECT 
                n.NIVEL_MCER,
                p.GENERO,
        ...
        titulo_filtros = f"{selected_year} - Intensificación"
        ...
        st.header("📊 Distribución por Nivel MCER - Intensificación")
        ...
        titulo_grafico = 'Distribución por Nivel MCER y Genero - Intensificación'
        ...
        with col2:
            ...
            if total_estudiantes > 0:
                ...
                ax_pie.set_title('Distribución por Genero - Intensificación', fontsize=14, fontweight='bold', pad=20)
                st.pyplot(fig_pie)
