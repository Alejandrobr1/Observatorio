...
st.set_page_config(layout="wide", page_title="Dashboard MCER por Sexo - Intensificación")
st.title("📊 Estudiantes por Nivel MCER y Sexo - Intensificación")
...
try:
    with engine.connect() as connection:
        ...
        titulo_grafico = 'Distribución por Nivel MCER y Sexo - Intensificación'
        ...
        with col2:
            ...
            if total_estudiantes > 0:
                ...
                ax_pie.set_title('Distribución por Sexo - Intensificación', fontsize=14, fontweight='bold', pad=20)
                st.pyplot(fig_pie)
