...
st.set_page_config(layout="wide", page_title="Dashboard Aprobación de Estudiantes - Formación Sábados")
st.title("📊 Aprobación de Estudiantes por Año - FORMACIÓN SÁBADOS")
...
try:
    with engine.connect() as connection:
        # Consulta para obtener estado de aprobación - SOLO FORMACION SABADOS Y ESTUDIANTES
        query = text("""
            SELECT 
                n.ESTADO_ESTUDIANTE,
        ...
        st.header(f"📊 Distribución de Aprobación - Formación Sábados - Año {selected_year}")
        ...
        with col1:
            ...
            ax.set_title(f'Aprobación de Estudiantes - Formación Sábados\nAño {selected_year}', 
        ...
        ax_bar.set_title(f'Cantidad de Estudiantes por Estado - Formación Sábados - Año {selected_year}', 
