...
st.set_page_config(layout="wide", page_title="Dashboard MCER por Sexo - Formación Sábados")
st.title("📊 Estudiantes por Nivel MCER y Sexo - FORMACIÓN SÁBADOS")
...
try:
    with engine.connect() as connection:
        ...
        titulo_grafico = 'Distribución por Nivel MCER y Sexo - Formación Sábados'
