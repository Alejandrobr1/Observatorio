...
print("=" * 80)
print("POBLANDO NOMBRE_CURSO EN Persona_Nivel_MCER - 2025")
print("=" * 80)
...
try:
    ...
    df = pd.read_csv(ruta_archivo, sep=';', encoding='utf-8-sig', dtype={'NÚMERO DE IDENTIFICACIÓN': str})
    ...
    with engine.connect() as connection:
        ...
        for numero_doc, nombre_curso in nombre_curso_map.items():
            ...
            result = connection.execute(text(
                """UPDATE Persona_Nivel_MCER 
                   ...
                   WHERE PERSONA_ID = :persona_id AND ANIO_REGISTRO = 2025"""
        ...
        stats = connection.execute(text(
            """SELECT 
               ...
               WHERE ANIO_REGISTRO = 2025"""
        )).fetchone()
        
        print(f"   Total registros 2025: {stats[0]}")
        ...
        print("\n" + "=" * 80)
        print("✅ POBLACIÓN COMPLETADA - 2025")
        print("=" * 80)
