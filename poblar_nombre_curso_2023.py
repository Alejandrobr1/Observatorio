...
print("=" * 80)
print("POBLANDO NOMBRE_CURSO EN Persona_Nivel_MCER - 2023")
print("=" * 80)
    ...
    with engine.connect() as connection:
        ...
        for numero_doc, nombre_curso in nombre_curso_map.items():
            ...
            result = connection.execute(text(
                """UPDATE Persona_Nivel_MCER 
                   ...
                   WHERE PERSONA_ID = :persona_id AND ANIO_REGISTRO = 2023"""
        ...
        stats = connection.execute(text(
            """SELECT 
               ...
               WHERE ANIO_REGISTRO = 2023"""
        )).fetchone()
        
        print(f"   Total registros 2023: {stats[0]}")
        ...
        print("\n" + "=" * 80)
        print("✅ POBLACIÓN COMPLETADA - 2023")
        print("=" * 80)
