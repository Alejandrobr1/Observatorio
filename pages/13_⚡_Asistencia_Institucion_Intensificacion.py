"""
Dashboard: Análisis de Estudiantes por Institución - Formación Intensificación
"""
...
with engine.connect() as connection:
    ...
    if not available_years:
        st.warning("⚠️ No hay datos disponibles para Intensificación")
        st.stop()
...
if data:
    ...
    st.warning(f"⚠️ No hay datos para Intensificación en el año {selected_year}")
