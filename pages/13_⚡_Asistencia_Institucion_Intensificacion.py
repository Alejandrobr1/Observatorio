"""
Dashboard: Asistencia por Institución - Formación Intensificación
"""
...
st.set_page_config(page_title="Asistencia Institución - Intensificación", layout="wide", page_icon="🏫")

st.title("🏫 Asistencia por Institución - Formación Intensificación")
...
if data:
    ...
    st.warning(f"⚠️ No hay datos de asistencia para Intensificación en el año {selected_year}")
