...
import sys 
import os
from dashboard_config import COLOMBO_LABEL, COMFENALCO_LABEL, DOCENTES_LABEL, create_nav_buttons, DASHBOARD_CATEGORIES# Añadir el directorio raíz del proyecto a sys.path
