...
st.set_page_config(page_title="Estudiantes por Institución - Formación Sábados", layout="wide", page_icon="📚")
...
st.info("Dashboard: Estudiantes por Institución - Formación Sábados")
