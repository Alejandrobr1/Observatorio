...
st.set_page_config(page_title="Niveles MCER - Formación Sábados", layout="wide", page_icon="📚")
st.title("📚 Niveles MCER - Formación Sábados")
...
st.info("Dashboard: Niveles MCER - Formación Sábados")
