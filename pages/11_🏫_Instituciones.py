...
st.set_page_config(page_title="Instituciones - Formación Intensificación", layout="wide", page_icon="🏫")
st.title("🏫 Instituciones - Formación Intensificación")
...
st.info("Dashboard: Instituciones - Formación Intensificación")
