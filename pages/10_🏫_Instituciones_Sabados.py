"""
Dashboard: Instituciones - Formación Sábados
"""
...
st.set_page_config(page_title="Instituciones - Sábados", layout="wide", page_icon="🏫")

st.title("🏫 Distribución por Institución - Formación Sábados")
