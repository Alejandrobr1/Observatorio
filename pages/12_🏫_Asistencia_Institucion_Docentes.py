"""
Dashboard: Análisis de Estudiantes por Institución - Formación Docentes
"""
...
st.set_page_config(page_title="Estudiantes por Institución - Docentes", layout="wide", page_icon="🏫")
...
with engine.connect() as connection:
    ...
    if not available_years:
        st.warning("⚠️ No hay datos disponibles para Docentes")
        st.stop()
...
if data:
    ...
    st.warning(f"⚠️ No hay datos para Docentes en el año {selected_year}")
