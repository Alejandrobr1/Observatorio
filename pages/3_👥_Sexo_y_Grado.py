...
st.set_page_config(page_title="Sexo y Grado - Formación Docentes", layout="wide", page_icon="👥")
st.title("👥 Sexo y Grado - Formación Docentes")
...
# Query para Sexo y Grado - Docentes
query = """
SELECT 
    p.SEXO,
