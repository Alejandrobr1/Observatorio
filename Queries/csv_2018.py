...
NIVEL_MCER_2018 = df[["NIVEL_MCER","POBLACIÓN","ESTADO ETAPA 2","ANIO","IDIOMA","CERTIFICADO","GRADO"]].drop_duplicates().reset_index(drop=True)
...
PERSONA_NIVEL_2018 = df[["NÚMERO DE IDENTIFICACIÓN","NIVEL_MCER","POBLACIÓN","ANIO"]].copy()
