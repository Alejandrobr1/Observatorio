...
if grado_col != 'GRADO':
    NIVEL_MCER_2022 = NIVEL_MCER_2022.rename(columns={grado_col: 'GRADO'})

NIVEL_MCER_2022 = NIVEL_MCER_2022.drop_duplicates().reset_index(drop=True)

print(f"\n✓ NIVEL_MCER_2022 preparado: {len(NIVEL_MCER_2022)} registros únicos")
print(f"  Grados únicos: {sorted(NIVEL_MCER_2022['GRADO'].unique())}")
print(f"  Distribución:")
print(NIVEL_MCER_2022['GRADO'].value_counts())
...
PERSONA_NIVEL_2022 = df[["NÚMERO DE IDENTIFICACIÓN","NIVEL_MCER","TIPO POBLACION","ANIO","GRADO"]].copy()
