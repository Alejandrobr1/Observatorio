...
if grado_col != 'GRADO':
    NIVEL_MCER_2020 = NIVEL_MCER_2020.rename(columns={grado_col: 'GRADO'})

NIVEL_MCER_2020 = NIVEL_MCER_2020.drop_duplicates().reset_index(drop=True)

print(f"\n✓ NIVEL_MCER_2020 preparado: {len(NIVEL_MCER_2020)} registros únicos")
print(f"  Grados únicos: {sorted(NIVEL_MCER_2020['GRADO'].unique())}")
print(f"  Distribución:")
print(NIVEL_MCER_2020['GRADO'].value_counts())
...
PERSONA_NIVEL_2020 = df[["NÚMERO DE IDENTIFICACIÓN","NIVEL_MCER","TIPO POBLACION","ANIO","GRADO"]].copy()
