...
try:
            ...
            try:
                ...
                connection.execute(text(
                    """INSERT INTO Estudiantes_2021_2025 
                       (FECHA, INSTITUCION_EDUCATIVA, POBLACION, GRADO, JORNADA, NIVEL_MCER)
                       VALUES (:fecha, :institucion_educativa, :poblacion, :grado, :jornada, :nivel_mcer)"""
                ), {
                    'fecha': reg['FECHA'],
    ...
    with engine.connect() as connection:
        ...
        grado_query = connection.execute(text(
            "SELECT GRADO, COUNT(*) as cantidad FROM Estudiantes_2021_2025 GROUP BY GRADO ORDER BY GRADO"
        ))
        print(f"\n   Grados:")
