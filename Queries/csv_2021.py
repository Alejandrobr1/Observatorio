...
if grado_col != 'GRADO':
    NIVEL_MCER_2021 = NIVEL_MCER_2021.rename(columns={grado_col: 'GRADO'})

NIVEL_MCER_2021 = NIVEL_MCER_2021.drop_duplicates().reset_index(drop=True)

print(f"\n✓ NIVEL_MCER_2021 preparado: {len(NIVEL_MCER_2021)} registros únicos")
print(f"  Grados únicos: {sorted(NIVEL_MCER_2021['GRADO'].unique())}")
print(f"  Distribución:")
print(NIVEL_MCER_2021['GRADO'].value_counts())
...
PERSONA_NIVEL_2021 = df[["NÚMERO DE IDENTIFICACIÓN","NIVEL_MCER","TIPO POBLACION","ANIO","GRADO"]].copy()
