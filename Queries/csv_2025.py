...
if grado_col != 'GRADO':
    NIVEL_MCER_2025 = NIVEL_MCER_2025.rename(columns={grado_col: 'GRADO'})

NIVEL_MCER_2025 = NIVEL_MCER_2025.drop_duplicates().reset_index(drop=True)

print(f"\n✓ NIVEL_MCER_2025 preparado: {len(NIVEL_MCER_2025)} registros únicos")
print(f"  Grados únicos: {sorted(NIVEL_MCER_2025['GRADO'].unique())}")
print(f"  Distribución:")
print(NIVEL_MCER_2025['GRADO'].value_counts())
...
PERSONA_NIVEL_2025 = df[["NÚMERO DE IDENTIFICACIÓN","NIVEL_MCER","TIPO POBLACION","ANIO","GRADO"]].copy()
