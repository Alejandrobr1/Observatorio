...
print(f"  - Total filas: {len(PERSONA_NIVEL_2017)}")
print(f"  - Con NIVEL_MCER != 'SIN INFORMACION': {len(PERSONA_NIVEL_2017[PERSONA_NIVEL_2017['NIVEL_MCER'] != 'SIN INFORMACION'])}")
print(f"  - Niveles únicos: {sorted(PERSONA_NIVEL_2017['NIVEL_MCER'].unique())}")
print(f"  - Años únicos: {sorted(PERSONA_NIVEL_2017['ANIO'].unique())}")
...
print(f"Total personas a procesar: {len(PERSONAS_2017)}")
