...
if grado_col != 'GRADO':
    NIVEL_MCER_2016 = NIVEL_MCER_2016.rename(columns={grado_col: 'GRADO'})

NIVEL_MCER_2016 = NIVEL_MCER_2016.drop_duplicates().reset_index(drop=True)

print(f"\n✓ NIVEL_MCER_2016 preparado: {len(NIVEL_MCER_2016)} registros únicos")
print(f"  Grados únicos: {sorted(NIVEL_MCER_2016['GRADO'].unique())}")
print(f"  Distribución:")
print(NIVEL_MCER_2016['GRADO'].value_counts())
...
PERSONA_NIVEL_2016 = df[["NÚMERO DE IDENTIFICACIÓN","NIVEL_MCER","TIPO POBLACION","ANIO","GRADO"]].copy()
