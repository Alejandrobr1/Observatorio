...
with tab2:
    ...
    with col2:
        st.page_link("pages/2_👥_Sexo_y_Grado.py", label="👥 Sexo y Grado", icon="👥")
        st.page_link("pages/8_📚_Niveles_MCER.py", label="📚 Niveles MCER", icon="📚")
    with col3:
        st.page_link("pages/10_🏫_Instituciones.py", label="🏫 Instituciones", icon="🏫")
        st.page_link("pages/14_📚_Estudiantes_por_Institución.py", label="📚 Estudiantes x Institución", icon="📚")
    st.divider()
    ...
    col1, col2 = st.columns(2)
    with col1:
        st.page_link("pages/3_👥_Sexo_y_Grado.py", label="👥 Sexo y Grado", icon="👥")
    with col2:
        st.page_link("pages/12_🏫_Estudiantes_por_Institución.py", label="🏫 Estudiantes x Institución", icon="🏫")
    st.divider()
    ...
    with col2:
        st.page_link("pages/5_📈_Sexo_y_Grado.py", label="� Sexo y Grado", icon="�")
        st.page_link("pages/9_📚_Niveles_MCER.py", label="📚 Niveles MCER", icon="📚")
    with col3:
        st.page_link("pages/11_🏫_Instituciones.py", label="🏫 Instituciones", icon="🏫")
        st.page_link("pages/13_⚡_Estudiantes_por_Institución.py", label="⚡ Estudiantes x Institución", icon="⚡")
    st.divider()
